    ...
    <footer class="site-footer">
        <div class="footer-grid">
            ...
            <div class="footer-col">
                ...
                <ul class="footer-list">
                    ...
                    <li>📅 <a href="https://www.coentropy.net/appointment.html">Book a free consultation</a></li>
            ...
            <div class="footer-col">
                ...
                <ul class="footer-list">
                    ...
                    <li><a href="https://www.coentropy.net/services.html">Smart Home Setup</a></li>
                    <li><a href="https://www.coentropy.net/services.html">Website Design</a></li>
            ...
            <div class="footer-col">
                ...
                <ul class="footer-list" style="margin-top: 0.8rem;">
        ...
        <div class="footer-bottom">
            <p>&copy; <?php echo date('Y'); ?> CoEntropy.net &mdash; Brendan Coen &mdash;
            Santa Rosa, CA &mdash;
            <a href="mailto:brendan@coentropy.net">brendan@coentropy.net</a></p>
        </div>
    </footer>
